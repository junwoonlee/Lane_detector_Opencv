...
def Perspective_Tf(img, vertices):
    pts2 = np.float32([[10,10],[10,1000],[1000,10],[1000,1000]])
    pts1 = np.float32([vertices[0][0],vertices[0][1],vertices[0][3],vertices[0][2]])
...
image_raw = cv2.imread("C:/Users/JUN/Desktop/DR PR/2021.11 CV_car_driving_Project/test1.png")
...
rwfi = Perspective_Tf(image_raw, vertices)

tr_img = draw_lines(image_raw, Regressed_lines)
#display_file(tr_img, 1080, 640)
display_file(ROI_GBimage, 1080, 640)
#display_file(rwfi, 1080, 640)